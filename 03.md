# Exercise 3: Start small and expand a migration landing zone
...
5. Next, set the **Definition Location** value to a subscription named **Name-of-your-subscription** and then click on **Select** and return to the Create blueprint page.
...
13. On the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
     ...
     **Basics**
     - **Subscriptions**: The subscription `Name-of-your-subscription` should be pre-selected and grayed out. This value reflects the Subscription where your Blueprint copy is saved.
     ...
     **Blueprint parameters:** 
     ...
     - **Organization:** Enter your organization name as **TWT**
     ...
     **Artifact parameters**
      ...
      - **Deploy Key Vault:** 
        - Object Id of your own Azure AD User (Check in Azure Active Directory), Object id value is used to get the required permissions on key vault. 
      
      - **Deploy Log Analytics:** `30` is the value for the number of days the data will be retained in Log Analytics.
        
          **Region:** `East US 2`
      
      - **Deploy vNET Landing zone :** Provide the Virtual Network IP Address space as `172.16`
      
      - **Deploy Azure Migrate:** 
         Select the region for Azure Migrate: `East US 2`
...
16. Observe the resources which are being deployed by the blueprint.
    ...
    >You can also check the deployment status by opening the blueprint assignment **Assignment-L1-Migrationlandingzone** from the **Blueprints** page and **Assigned blueprints** section, ensure you select the right scope **Name-of-your-subscription**
...
19. On the **Resource Groups** blade filter the resource groups by Subscription **Name-of-your-subscription** and verify that the following four resource groups were created:
     -  **TWT-Migrate-rg**
     -  **TWT-SharedSvcs-rg**
     -  **TWT-VNet-rg**
     -  **NetworkWatcherRG**
...
- In the **gateway subnet**, traffic sent to the web-tier subnet (172.16.1.0/24) is routed through the Azure Firewall instance.
...
1. Navigate to the **Blueprints** page and under the **Assigned blueprints** section, select **Assignment-L1-Migrationlandingzone** then click on **Unassign blueprint** to unassign the previously assigned blueprint.
   ...
   >Select the scope **Name-of-your-subscription** if it is set to a different subscription.
...
5. Download the file **vnetdmz-deploy.json** located under the **Template** folder in **GitHub Repository** provided by the instructor. After that, click on folder 📂 symbol under Import template which deploys the **virtual network** with DMZ architecture.
...
11. Now on the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
    ...
    **Basics**
     ...
     **Artifact parameters**
      ...
      - **Deploy Azure Migrate:**`East US 2`
...
17. On the **Resource Groups** blade filter the subscription **Name-of-your-subscription** and select the resource group **DMZ-VNet-rg** and review the resources deployed along with the virtual network
