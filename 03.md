...
13. On the **Assign blueprint** page, provide the parameter values for the blueprint assignment:
     ...
     **Artifact parameters**
      ...
      - **Deploy Key Vault:** 
        - Objectid of your main Azure AD User, Object id value is used to get the required permissions on key vault. 
...
5. Download the file **vnetdmz-deploy.json** located in **GitHub Repository** provided by the instructor under the Template folder. After that, click on folder 📂 symbol under Import template which deploys the **virtual network** with DMZ architecture.
